      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Seleziona un giorno per vedere gli arrivi previsti.
          </p>
        </div>

        {/* Week Days Selector */}
        <div 
          className={`flex justify-center gap-2 md:gap-3 mb-12 transition-all duration-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        ...
        {/* Arrivals Display */}
        <div 
          className={`min-h-[160px] flex flex-col items-center justify-center transition-all duration-500 ${
        ...
        {/* Info Note */}
        <p 
          className={`text-center text-xs text-muted-foreground/70 mt-12 transition-all duration-700 ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}
