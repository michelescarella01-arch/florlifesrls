  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="px-5 py-4 border-b border-border bg-muted/30">
            <p className="font-serif text-lg text-foreground">{lang === "it" ? "Contatta Florlife" : "Contact Florlife"}</p>
          </div>
      ...
      <button
        ...
        aria-label={isOpen ? (lang === "it" ? "Chiudi contatti" : "Close contacts") : (lang === "it" ? "Apri contatti WhatsApp" : "Open WhatsApp contacts")}
      >
        {isOpen ? (
          <X className="w-5 h-5" />
        ) : (
